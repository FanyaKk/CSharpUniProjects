...
namespace Book.Controllers
{
    public class MagazinesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,Editor,Pages,Price,ReleaseDate")] Magazine magazine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,Editor,Pages,Price,ReleaseDate")] Magazine magazine)
        {
            if (ModelState.IsValid)
            {
